...
const config = {
    ...
    ({
		...
		navbar: {
			// hideOnScroll:true,
			title: 'JavaScript Booking Documentation',
			logo: {
				alt: 'DHTMLX JavaScript Booking Logo',
				src: 'img/logo.svg',
			...
			"links": [
				...
				},
				{
					...
					"items": [
						...
						{
							"label": "Licensing",
							"href": "https://dhtmlx.com/docs/products/dhtmlxBooking/#licensing" // [TODO] change before release
						}
					]
				}
			],
		...
		algolia: {
			...
			indexName: 'bookingalt', // TODO: change it

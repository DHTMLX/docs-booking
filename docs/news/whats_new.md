...
- Lazy rendering of cards via the [`renderType`](api/config/booking-rendertype.md) property
...
- [Various rules](guides/configuration.md#define-slot-rules) for defining item slots

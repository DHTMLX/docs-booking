...
title: Стилизация
description: В документации библиотеки DHTMLX JavaScript Booking вы можете узнать о стилизации виджета. Изучите руководства разработчика и справочник API, попробуйте примеры кода и живые демо, а также скачайте бесплатную 30-дневную ознакомительную версию DHTMLX Booking.
---
...
Следующий фрагмент кода показывает подмножество переменных, специфичных для Booking, которые предоставляет виджет (показаны со значениями для десктопа; внутренне виджет переопределяет некоторые из них для десктопа, планшета и мобильного):
...
Виджет предоставляет единственную встроенную тему Material.

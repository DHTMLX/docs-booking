...
title: slotGap
description: В документации DHTMLX JavaScript Booking библиотеки вы можете узнать о параметре slotGap. Изучите руководства разработчика и справочник API, попробуйте примеры кода и живые демо, а также загрузите бесплатную 30-дневную ознакомительную версию DHTMLX Booking.
---

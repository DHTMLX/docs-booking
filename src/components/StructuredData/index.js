...
const SITE_NAME = 'DHTMLX Booking Docs';
const PRODUCT_NAME = 'DHTMLX Booking';
const PRODUCT_URL = 'https://dhtmlx.com/docs/products/dhtmlxBooking/';

function resolveType(pathname) {
	const path = (pathname || '').replace(/\/+$/, '');
	if (path === '' || path === '/booking') return 'SoftwareApplication';
